<template>
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-akbpaGreen-50 via-white to-gray-50 dark:from-gray-950 dark:via-gray-950 dark:to-gray-900 px-4 py-10 relative">
